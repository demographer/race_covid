## Create deaths by race and state from "weekly_state_updates_diff" file from CDC 
...
cdc_race_filename = "../data/provisional_death_counts_for_COVID-19__weekly_state_updates_diff.csv"
...
fwrite(clean_cdc_race_out.dt, "../data/clean_cdc_race_diff.csv")
